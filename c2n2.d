...
void main(string[] args) {
	if (args.length == 1) {
		foreach(chrNum; [ChrNum("Jennifer Christensen", "I 1st noticed this when that age."),
						ChrNum("Jennifer Bender Christensen"),
						ChrNum("Joel Christensen"),
						ChrNum("Jennifer Bender"),
						ChrNum("Joel and Jennifer Christensen", "(7x7=49) 7 is the number for Spiritual perfection for" ~
							" each of us!"),
						ChrNum("Jennifer Christensen - Bender", "My house number"),
						ChrNum("Joel Jennifer kiss", "My favourite number"),
		...
		foreach(chrNum; [ChrNum("Joel Jennifer kiss", "(7 is spiritual perfection, 17 is the 7th prime number, 10 is " ~
								 " ordinal perfection, both together, are the perfection of spiritual order. " ~
								 "See Rom 8:35-39, a list of 7 then list of 10)"),
						  ChrNum("Joel and Jennifer Christensen"),
						  ChrNum("JENNIFER!", "the number on the number plate on my 1st car"),
						  ChrNum("WINDOWS96"),
		...
		foreach(chrNum; [ChrNum("Joel wants Jennifer heart", "240 Amstrad 8 bit computer character is an up arrow " ~
		...
		foreach(chrNum; [ChrNum("Joel"),
						 ...
						 ChrNum("Jennifer","7x7"),
						 ChrNum("Joel loves Jennifer","my birthday is on the fourth month"),
						 ChrNum("Joel Jennifer married"),
						 ChrNum("Joel Jennifer kiss"),
						 ChrNum("alan"),
						 ChrNum("ria"),
						 ChrNum("neville"),
						 ChrNum("Rhondda"),
